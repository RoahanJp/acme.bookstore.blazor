...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p f8cfa9c9-458d-4e3b-b7ac-360e732d772c
```

> `f8cfa9c9-458d-4e3b-b7ac-360e732d772c` is the password of the certificate, you can change it to any password you want.
